...
public class OssClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAIJfPQXEJMsnqq";
    private String accessKeySecret = "Jhvwrx1FqHiVfq1SBDcf9ApvXglp3q";
    // 空间
    private String bucketName = "ljwstart";
    // 文件存储目录
