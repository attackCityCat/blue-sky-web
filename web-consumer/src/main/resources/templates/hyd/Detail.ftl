...
<head>
    ...
    <script charset="UTF-8" type="text/javascript" src="/hyd/llp/Personal/layer.js">
    </script>
    <link rel="stylesheet" href="/hyd/llp/Personal/layer.css">

    <link href="/hyd/llp/css/base.min.css" rel="stylesheet"/>
    <link href="/hyd/llp/css/jquery.flexslider.css" rel="stylesheet"/>
    <link href="/hyd/llp/css/main.min.css" rel="stylesheet"/>
    <script src="/hyd/llp/js/jquery.1.7.2.min.js" type="text/javascript"></script>
    <script src="/hyd/llp/js/json2.min.js" type="text/javascript"></script>
    <script src="/hyd/llp/js/jquery.tool.tabs.min.js" type="text/javascript"></script>
    <script src="/hyd/llp/js/helper.js" type="text/javascript"></script>
    <script src="/hyd/llp/js/jquery.flexslider.min.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    function toXuanZuo(id) {
        $.ajax({
            url:'/hyd/findPaiSeatSum',
            data:{
                id:id
            },
            success:function (data) {
                if (data){
                    location.href="/xinx/page/toSeat?id="+id;
                }
            }
        })
    }
                ...
                <div class="screen-list" style="display: block;">
                    <div class="cinemaScreen">
                        <div class="cinema-info">
                            ...
                            <span class="logo"> <img src="/xinx/img/ban.jpg"> </span>
                            <div class="action"><p class="price-start"><strong>${MoviesDetail.price}</strong>起</p>
                        ...
                        <ul id="ulId" class="screening hide">
                            ...
                            <#list paiqiBean as i>
                                ...
                                <li class="clearfix">
                                    ...
                                    <p class="item w2">
                                        <#if i.language ==2>国语</#if>
                                        <#if i.language ==3>英语</#if>
                                        <#if i.language ==1>原版</#if>
                                    </p>
                                    <p class="item w3">${i.hallName}</p>
                                    <p class="item stand-pric w4">¥${i.price}</p>
                                    <p class="item w5" style="color:red">¥${i.price}</p>
                                    <p class="item w6">
