...
//                            alert($('#' + args[n]).find('.myid').html())

                            $('#' + args[n]).find('.data').removeClass('data').html(' - Cancelled');
                            myid = $('#' + args[n]).find('.myid').html();
...
//调整     
    ...
    var handlers = {
        ...
        onDialogOpen: function() {
            ...
            this.queueData.errorMsg = '一些文件没有成功加入队列:';
...
//                }
            ...
            if ($.inArray('onSelect', settings.overrideEvents) < 0) {
                ...
                $('#' + settings.queueID).html('<div class="uploadify-queue-item hai-bg-dark"  id="' + file.id + '">\
<b  class="js-component-icon "></b>\
<div class="j" title="' + fileName + '">' + fileName + ' (' + fileSize + ')</div>\
<div class="k "><span class="uploadify-progress" ><span class="uploadify-progress-bar"><!--Progress Bar--></span></span><span class="data hai-txt-suc"></span></div>\
<div class="myid" style="display:none">0</div>\
</div>');
...
//调整    
        ...
        onUploadSuccess: function(file, data, response) {
            ...
            if ($.inArray('onUploadSuccess', settings.overrideEvents) < 0) {
                ...
                $('#' + file.id).find('.myid').html(data);  //填写返回值
            }
